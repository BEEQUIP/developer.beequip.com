...
You can find your token on the settings page in your Beeport account. If you don’t have an account, you can request [one](https://beequip.com/nl/producten/beeport-dealers-handelaren).
